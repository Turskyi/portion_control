...
class SupportPage extends StatelessWidget {
  ...
  String get _mainSupportText {
    return '''
${translate('support_page.welcome_message', args: <String, Object?>{'appName': res.kAppName})}

${translate('support_page.about_app_title')}

 ${translate('support_page.about_app_content', args: <String, Object?>{'appName': res.kAppName})}
